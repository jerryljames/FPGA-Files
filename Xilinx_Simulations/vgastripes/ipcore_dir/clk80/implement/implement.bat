...
xst -ifn xst.scr
move clk80_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk80_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk80_exdes.ucf clk80_exdes

echo 'Running map'
map -timing -pr b clk80_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk80_exdes -w routed.ncd routed.v
cd ..
